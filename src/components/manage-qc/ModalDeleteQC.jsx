...
const ModalDeleteQC = ({
  ...
  //   delete from db
  const deleteQC = async () => {
    try {
      await privateApi.delete(
        "/qc/delete",
        {
          // data qc yang akan dihapus
          data: {
            id_qc: idQC,
          },
        },
        {
          // headers Authorization untuk akses route /qc/delete
          headers: {
            Authorization: token,
          },
        }
          ...
          <div className="border-0 bg-gray-800  rounded-lg shadow-lg relative flex flex-col outline-none focus:outline-none max-w-fit md:w-full">
            ...
            <div className="relative p-6 flex-auto">
              ...
              <p className="text-white">
                Anda yakin akan menghapus data Quality Control dengan kode:{" "}
                {kodeQC}?
              </p>
            </div>
            {/*footer*/}
