...
const ModalCreateQC = ({ setShowModal, token, setSuccess, idProduk }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await privateApi.post(
        ...
        // headers untuk akses route membuat hasil QC
